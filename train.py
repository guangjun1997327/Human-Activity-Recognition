...
class Trainer(object):
    def __init__(self, model, ds_train, ds_val, total_steps, log_interval, lr, activation, check_path, check_path2):
        # Summary Writer
        # ....
        ...
        self.checkpoint2 = tf.train.Checkpoint(model=self.model, optimizer=self.optimizer)
        self.check_path2 = check_path2
        self.checkmanager2 = tf.train.CheckpointManager(self.checkpoint2, directory=self.check_path2, max_to_keep=10)
